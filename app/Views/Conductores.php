<html lang="en">
 ...
 <?php require_once('header.php')  ?>
      <div class="container">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalinsertConductor">
  Agregrar conductor
</button>

      <h2>listar Conductores</h2> 
      <div class="table-responsive">
         <table class="table" id="tableconductores">
            <thead>
               <tr>
                  <th>id</th>
                  <th>cedula</th>
 ...
 <th>eliminar </th>
            ...
            <tbody  class="cuerpoTableC">
               
            </tbody>
         </table>
      </div> 

      <div id="myModalinsertConductor" class="modal fade" role="dialog">
      
     <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
<h4 class="modal-title">insertConductores </h4>               
<button type="button" class="close" data-dismiss="modal">&times;</button>
               
            </div>
            <div class="modal-body">
               <form id="Formsavecond" class="needs-validation" novalidate >
...
<div class="invalid-feedback">
   ...
   <div class="invalid-feedback">
      ...
      <div id="myModalshowConductor" class="modal fade" role="dialog">
...
<button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body" id="mostrarConductor">
              
          </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
             <button type="button" class="btn btn-primary" id="UpdateC">Guardar</button>
            </div>
         </div>
      </div>
 </div>  
     ...
     <script src="./public/js/conductores.js"> </script>  
</html>